        ...
        <FORM action="Modi.php" method="POST" name="FormModi">
            <table width="356">
                ...
                <tr>
                    ...
                    <td width="243"> <input type="TEXT" name="pais" size="20" maxlength="30" value="<?php echo ($fila['pais']); ?>">
                    </td>
                </tr>
                <tr>
                    <td width="103"> Habitantes: </td>
                    <td width="243"> <input type="TEXT" name="habitantes" size="20" maxlength="30" value="<?php echo ($fila['habitantes']); ?>">
                    </td>
                </tr>
                <tr>
                    <td width="103"> Superficie: </td>
                    <td width="243"> <input type="TEXT" name="superficie" size="20" maxlength="20" value="<?php echo ($fila['superficie']); ?>">
                    </td>
                </tr>
                <tr>
                    <td width="103"> Tiene Metro: </td>
                    <td width="243"> <input type="TEXT" name="tieneMetro" size="20" maxlength="1" value="<?php echo ($fila['tieneMetro']); ?>">
                    </td>
                </tr>
                <tr>
